// Video Edits categorized into 4 albums
const INSTAGRAM_THUMBNAILS = [
  'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=800&q=65',
  'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=60&sat=-20',
  'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=900&q=65',
  'https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&w=900&q=65',
  'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=900&q=65',
  'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=900&q=65',
  'https://images.unsplash.com/photo-1489515217757-5fd1be406fef?auto=format&fit=crop&w=900&q=65'
];

const attachThumbnails = (items, offset = 0) =>
  items.map((item, index) => {
    const thumbnail = INSTAGRAM_THUMBNAILS[(offset + index) % INSTAGRAM_THUMBNAILS.length];
    return {
      ...item,
      thumbnail,
