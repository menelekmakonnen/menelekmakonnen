...
// Photography Albums - Gallery folder
export const PHOTOGRAPHY_DRIVE_FOLDER = '1G_6TgOtftLKwqRWjH-tFLuCgp_Oydor4';

// AI Albums - Gallery folder  
export const AI_ALBUMS_DRIVE_FOLDER = '1LflEx48azcfu_EBnLv12SOYWhUMXYoBj';

// Loremaker Cloud - Gallery folder
export const LOREMAKER_DRIVE_FOLDER = '1OYYhDG2KxJQtl2aKVAK1iZeUUWYv-BFz';
...
export function getDriveImageUrl(fileIdOrUrl) {
  ...
  // use standard export link which redirects to googleusercontent
