...
/**
 * Fetch characters from spreadsheet using Google Visualization API (no API key needed)
 */
export async function fetchLoremakerCharacters() {
  try {
    ...
    // More robust way to extract JSON from Gviz response
    ...
    return characters.length > 0 ? characters : MOCK_LOREMAKER_CHARACTERS;
  } catch (error) {
